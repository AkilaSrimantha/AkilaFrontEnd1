    ...
    return (
        <div className='footer'>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169; 2025 copyright all right reserved<br /><span>Designed with ❤️ by Akila Srimantha</span></p>
            </div>
        </div>
    )
}
